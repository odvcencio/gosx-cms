...
func StudioCommands(options StudioCommandOptions) []Command {
	...
	commands := []Command{
		...
		{Kind: CommandCanvas, Key: "canvas-fit", Label: "Fit website map", Summary: "Center every page, form, content, style, and release node in the canvas.", Group: "Canvas", Target: "fit", Keywords: []string{"site map", "spatial", "center"}},
